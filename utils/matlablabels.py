...
class MatlabLabels(object):
    ...
    def __init__(self):
        ...
        self.labels = ['IGNORE_B', 'IGNORE_E', '_I*_B', '_I*_E', '_IGNORE_B', '_IGNORE_E', '_I_B', '_I_E', '_MC_B',
                       ...
                       '_RET*_A0_E', '_RET*_A2_B', '_RET*_A2_E', '_RET*_B0_B', '_RET*_B0_E', '_RET*_B1_B', '_RET*_B1_E',
                       '_RET*_C0_B', '_RET*_C0_E', '_RET*_C_B', '_RET*_C_E', '_RET_1_B', '_RET_1_E', '_RET_2_B',
                       '_RET_2_E', '_RET_3_B', '_RET_3_E', '_RET_4_B', '_RET_4_E', '_RET_5_B', '_RET_5_E', '_RET_6_B',
                       '_RET_6_E', '_RET_7_B', '_RET_7_E', '_RET_8_B', '_RET_8_E', '_RET_A0_B', '_RET_A0_E',
                       '_RET_A1_B', '_RET_A1_E', '_RET_A2A0_B', '_RET_A2A0_E', '_RET_A2_B', '_RET_A2_E', '_RET_B',
                       '_RET_B0_B', '_RET_B0_E', '_RET_B1_B', '_RET_B1_E', '_RET_B2B0_B', '_RET_B2B0_E', '_RET_B2_B',
                       '_RET_B2_E', '_RET_C0_B', '_RET_C0_E', '_RET_C1_B', '_RET_C1_E', '_RET_C2_B', '_RET_C2_E',
                       '_RET_C_B', '_RET_C_E', '_RET_E', '_S*_C_B', '_S*_C_E', '_SM_B', '_SM_E', '_ST_B', '_ST_E',
                       '_S_1_B', '_S_1_E', '_S_2_B', '_S_2_E', '_S_3_B', '_S_3_E', '_S_4_B', '_S_4_E', '_S_5_B',
                       '_S_5_E', '_S_6_B', '_S_6_E', '_S_7_B', '_S_7_E', '_S_8_B', '_S_8_E', '_S_B', '_S_B0_B',
                       '_S_B0_E', '_S_C_B', '_S_C_E', '_S_E', '_T*_1C_B', '_T*_1C_E', '_T*_2C_B', '_T*_2C_E',
